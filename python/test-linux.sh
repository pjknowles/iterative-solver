...
for platform in $platforms; do
  ...
  bash --login -c " bash python/build.sh; cd /tmp; python -c 'import iterative_solver; print(iterative_solver.__version__)';  python -m unittest discover -s $root/python/test  "
done
