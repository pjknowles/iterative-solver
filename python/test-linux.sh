...
for platform in $platforms; do
  ...
  bash --login -c " bash python/build.sh; cd /tmp; python -c 'import iterative_solver; print(iterative_solver.__version__)';  python $root/python/test/test_rayleigh_quotient.py ; python -m unittest  "
done
