...
//                              molpro::cout << "after update, g\n"<<g<< std::endl;
                ...
                EXPECT_THAT(solver->errors(),
                            ::testing::Pointwise(::testing::DoubleNear(2 * solver->convergence_threshold()),
...
TEST(NonLinearEquations, trig1d) {
    ...
    auto solver =
            molpro::linalg::itsolv::create_NonLinearEquations<Rvector, Qvector>("DIIS",
                                                                                "convergence_threshold=1e-8,max_size_qspace=2");
