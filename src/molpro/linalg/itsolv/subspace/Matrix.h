#ifndef LINEARALGEBRA_SRC_MOLPRO_LINALG_ITSOLV_DETAIL_MATRIX_H
#define LINEARALGEBRA_SRC_MOLPRO_LINALG_ITSOLV_DETAIL_MATRIX_H
#include <stddef.h>
#include <utility>
...
#endif // LINEARALGEBRA_SRC_MOLPRO_LINALG_ITSOLV_DETAIL_MATRIX_H
