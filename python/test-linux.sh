...
for platform in $platforms; do
 ...
 ls -lR   bash --login -c " bash python/build.sh; cd /tmp; python -c 'import iterative_solver; print(iterative_solver.__version__)';  python $root/python/test_optimize.py   "
done
